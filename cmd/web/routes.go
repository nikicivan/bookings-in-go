...
func routes(app *config.AppConfig) http.Handler {
	...
	mux.Get("/king", handlers.Repo.King)
	...
	mux.Route("/admin", func(mux chi.Router) {
		...
		mux.Get("/process-reservation/{res}/{id}/do", handlers.Repo.AdminProcessReservation)
		mux.Get("/delete-reservation/{res}/{id}/do", handlers.Repo.AdminDeleteReservation)
